"""Control candidate for the DeepSeek V4 AITER/Triton block-FP8 fused MoE."""
...
def operator(
    ...
    if not _disable_aiter and use_aiter:
        try:
            ...
            # Match the reference's explicit lifetime boundary for AITER's
            # internally allocated asynchronous workspace.
